    ...
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans">
      <header className="bg-white shadow-sm px-6 py-4 flex justify-between items-center z-10">
        ...
        <div className="flex items-center space-x-4">
          <select className="border-gray-300 rounded-md text-lg border p-1 outline-none">
            <option>繁體中文</option>
      ...
      <main className="flex-grow flex items-center justify-center p-6 md:p-12 bg-slate-50">
        <div className="w-full max-w-4xl flex flex-col md:flex-row gap-8 md:gap-10 items-stretch justify-center">
          ...
          <div className="w-full md:w-1/2 bg-white p-8 sm:p-10 rounded-xl shadow-lg flex flex-col justify-center transition-all duration-300">
            <h2 className="text-2xl font-bold text-center text-black-500 mb-8">
            ...
            >
                  ...
                  <div>
                    ...
                    <div className="flex space-x-6">
                      <label className="flex items-center space-x-2 cursor-pointer group">
                        ...
                        />
                        <span className="text-sm text-slate-700 group-hover:text-primary transition">
                          老師
                        </span>
                      </label>
                      <label className="flex items-center space-x-2 cursor-pointer group">
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    <input
                      type="text"
                      placeholder="輸入驗證碼"
                      className="w-1/2 border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition"
                    />
                    <div className="w-1/2 bg-gray-50 flex items-center justify-center rounded-md border border-gray-200 border-dashed text-gray-500 font-mono tracking-widest text-lg select-none">
                      A2C8
                    </div>
                  </div>
                </div>
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white font-bold py-2.5 rounded-md mt-6 hover:bg-primary-dark transition duration-200 shadow-md hover:shadow-lg"
              >
                {isLoginMode ? "登入" : "立即註冊"}
              </button>
            </form>
